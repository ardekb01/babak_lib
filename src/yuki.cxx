...
short *find_subject_msp_using_transformation(char *imagefilename, char *prefix, char *msp_transformation_file)
{
   ...
   detect_AC_PC_MSP(imagefilename, orientation, AC, PC, VSPS, Tmsp, opt_T2);
...
void output_ppm(short *trg, short *cc_est, const char *prefix) 
{
   ...
   if(opt_W)
   {
      ...
      save_ppm((const char *)outputfile, NX, NY, R, G, B);
   }
   //////////////////////////////////////////////////////////////////////////////////
...
int main(int argc, char **argv)
{
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////
  // read the value of the ARTHOME environment variable
  /////////////////////////////////////////////////////////////////////////////////////////////
  getARTHOME();
